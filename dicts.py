Message_Types=["Message","Message and Gesture","Message Conjunction Message","Message Conjunction Message Gesture"]

Templates = ["$word ahead","No $word ahead","$word required ahead","Be wary of $word","Try $word","Likely $word","First off, $word","Seek $word","Still no $word...","Why is it always $word?","If only I had a $word...","Didn't expect $word...","Visions of $word...","Could this be a $word?","Time for $word","$word, O $word","Behold, $word!","Offer $word","Praise the $word","Let there be $word","Ahh, $word...","$word","$word!","$word?","$word..."]

Word_Categories=["Enemies","People","Things","Battle_Tactics","Actions","Situations","Places","Directions","Body_Parts","Affinities","Concepts","Phrases"]
...
Categories = {
    ...
    "Battle_Tactics": ["close-quarters battle","ranged battle","horseback battle","luring out","defeating one-by-one","taking on all at once","rushing in","stealth","mimicry","confusion","pursuit","fleeing","summoning","circling around","jumping off","dashing through","brief respite"],
    ...
    "Body_Parts": ["head","stomach","back","arms","legs","rump","tail","core","fingers"],
...
links={
    "As You Wish": "Gestures/pngs/As You Wish.png",
    "Balled Up": "Gestures/pngs/Balled Up.png",
    "Beckon": "Gestures/pngs/Beckon.png",
    "Bow": "Gestures/pngs/Bow.png",
    "Bravo!": "Gestures/pngs/Bravo!.png",
    "By My Sword": "Gestures/pngs/By My Sword.png",
    "Calm Down!": "Gestures/pngs/Calm Down!.png",
    "Casual Greeting": "Gestures/pngs/Casual Greeting.png",
    "Crossed Legs": "Gestures/pngs/Crossed Legs.png",
    "Curtsy": "Gestures/pngs/Curtsy.png",
    "Dejection": "Gestures/pngs/Dejection.png",
    "Desperate Prayer": "Gestures/pngs/Desperate Prayer.png",
    "Dozing Cross-Legged": "Gestures/pngs/Dozing Cross-Legged.png",
    "Erudition": "Gestures/pngs/Erudition.png",
    "Extreme Repentance": "Gestures/pngs/Extreme Repentance.png",
    "Fancy Spin": "Gestures/pngs/Fancy Spin.png",
    "Finger Snap": "Gestures/pngs/Finger Snap.png",
    "Fire Spur Me": "Gestures/pngs/Fire Spur Me.png",
    "Golden Order Totality": "Gestures/pngs/Golden Order Totality.png",
    "Grovel For Mercy": "Gestures/pngs/Grovel for Mercy.png",
    "Heartening Cry": "Gestures/pngs/Heartening Cry.png",
    "Hoslow'S Oath": "Gestures/pngs/Hoslow's Oath.png",
    "Inner Order": "Gestures/pngs/Inner Order.png",
    "Jump For Joy": "Gestures/pngs/Jump for Joy.png",
    "My Lord": "Gestures/pngs/My Lord.png",
    "My Thanks": "Gestures/pngs/My Thanks.png",
    "Nod In Thought": "Gestures/pngs/Nod In Thought.png",
    "Outer Order": "Gestures/pngs/Outer Order.png",
    "Patches' Crouch": "Gestures/pngs/Patches' Crouch.png",
    "Point Downwards": "Gestures/pngs/Point Downwards.png",
    "Point Forwards": "Gestures/pngs/Point Forwards.png",
    "Point Upwards": "Gestures/pngs/Point Upwards.png",
    "Polite Bow": "Gestures/pngs/Polite Bow.png",
    "Prayer": "Gestures/pngs/Prayer.png",
    "Rallying Cry": "Gestures/pngs/Rallying Cry.png",
    "Rapture": "Gestures/pngs/Rapture.png",
    "Rest": "Gestures/pngs/Rest.png",
    "Reverential Bow": "Gestures/pngs/Reverential Bow.png",
    "Sitting Sideways": "Gestures/pngs/Sitting Sideways.png",
    "Spread Out": "Gestures/pngs/Spread Out.png",
    "Strength!": "Gestures/pngs/Strength!.png",
    "The Ring": "Gestures/pngs/The Ring.png",
    "Triumphant Delight": "Gestures/pngs/Triumphant Delight.png",
    "Wait!": "Gestures/pngs/Wait!.png",
    "Warm Welcome": "Gestures/pngs/Warm Welcome.png",
    "Wave": "Gestures/pngs/Wave.png",
